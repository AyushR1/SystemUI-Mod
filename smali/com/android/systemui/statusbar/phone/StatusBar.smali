...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;,
...
# instance fields
.field private ambientClearingHandler:Landroid/os/Handler;

.field private ambientClearingRunnable:Ljava/lang/Runnable;
...
.field private mAmbientCallback:Lcom/android/systemui/ambient/play/AmbientIndicationManagerCallback;

.field private mAmbientIndicationContainer:Landroid/view/View;

.field private mAmbientIndicationManager:Lcom/android/systemui/ambient/play/AmbientIndicationManager;
...
.field private mRecognitionEnabled:Z

.field private mRecognitionEnabledOnKeyguard:Z
...
.field private mSbSettingsObserver:Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientCallback:Lcom/android/systemui/ambient/play/AmbientIndicationManagerCallback;
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$U2-_-jPHs6zuUW-29dyh2rf2vqM;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$U2-_-jPHs6zuUW-29dyh2rf2vqM;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mSbSettingsObserver:Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$hDeelqePS5c93c_smCoceo_JbeI;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$hDeelqePS5c93c_smCoceo_JbeI;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mAutoDim:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$FrwKL82awCvfsO6eEeQB614Yo5M;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$FrwKL82awCvfsO6eEeQB614Yo5M;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method static synthetic access$1000(Lcom/android/systemui/statusbar/phone/StatusBar;)Lcom/android/systemui/ambient/play/AmbientIndicationManager;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientIndicationManager:Lcom/android/systemui/ambient/play/AmbientIndicationManager;
...
.method static synthetic access$1802(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    .locals 0
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/StatusBar;)Z
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mRecognitionEnabled:Z

    return v0
.end method

.method static synthetic access$302(Lcom/android/systemui/statusbar/phone/StatusBar;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mRecognitionEnabled:Z

    return p1
.end method

.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/StatusBar;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/systemui/statusbar/phone/StatusBar;->hideAmbientPlayIndication(IZ)V
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/phone/StatusBar;)Z
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mRecognitionEnabledOnKeyguard:Z

    return v0
.end method

.method static synthetic access$702(Lcom/android/systemui/statusbar/phone/StatusBar;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mRecognitionEnabledOnKeyguard:Z
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/StatusBar;->showAmbientPlayIndication()V
...
.method private handleVisibleToUserChangedImpl(Z)V
    ...
    new-instance v5, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$L7CWWY68vvaxHKvHpan4z_UceUU;

    invoke-direct {v5, p0, v1, v3}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$L7CWWY68vvaxHKvHpan4z_UceUU;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;ZI)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$J1ouXjVsiGbik-dFy8e1gkHbor8;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$J1ouXjVsiGbik-dFy8e1gkHbor8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method private hideAmbientPlayIndication(IZ)V
    .locals 4

    :try_start_0
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->ambientClearingHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->ambientClearingRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    new-instance v0, Lcom/android/systemui/statusbar/phone/StatusBar$8;

    invoke-direct {v0, p0, p2}, Lcom/android/systemui/statusbar/phone/StatusBar$8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Z)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->ambientClearingRunnable:Ljava/lang/Runnable;
...
.method public static synthetic lambda$clearAllNotifications$14(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/util/ArrayList;)V
    .locals 5
...
.method public static synthetic lambda$executeRunnableDismissingKeyguard$25(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;ZZ)Z
    .locals 3
...
.method public static synthetic lambda$fadeKeyguardAfterLaunchTransition$33(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
    .locals 8
...
.method public static synthetic lambda$fadeKeyguardWhilePulsing$34(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 1
...
.method public static synthetic lambda$handleRemoteViewClick$36(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/NotificationRemoteInputManager$ClickHandler;)Z
    .locals 4
...
.method public static synthetic lambda$handleVisibleToUserChangedImpl$26(Lcom/android/systemui/statusbar/phone/StatusBar;ZI)V
    .locals 1
...
.method public static synthetic lambda$handleVisibleToUserChangedImpl$27(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 1
...
.method static synthetic lambda$maybeEscalateHeadsUp$20(Lcom/android/systemui/statusbar/NotificationData$Entry;)V
    .locals 4
...
.method public static synthetic lambda$new$28(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method public static synthetic lambda$new$49(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method static synthetic lambda$new$50(Ljava/lang/Runnable;)Z
    .locals 1
...
.method public static synthetic lambda$new$51(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;Landroid/service/notification/StatusBarNotification;)V
    .locals 2
    ...
    :cond_0
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gmnfeggGTJaRjfJHO2GTfe-r4PU;

    invoke-direct {v0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gmnfeggGTJaRjfJHO2GTfe-r4PU;-><init>(Ljava/lang/Runnable;)V
...
.method public static synthetic lambda$onHeadsUpPinnedModeChanged$17(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method public static synthetic lambda$onNotificationClicked$41(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/String;Lcom/android/systemui/statusbar/ExpandableNotificationRow;Landroid/service/notification/StatusBarNotification;Landroid/app/PendingIntent;Lcom/android/systemui/statusbar/RemoteInputController;Z)Z
    .locals 16
    ...
    new-instance v15, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$j_VWyEw2Y2X4khHBBJnisO4DaR8;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$j_VWyEw2Y2X4khHBBJnisO4DaR8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;Ljava/lang/String;Lcom/android/systemui/statusbar/ExpandableNotificationRow;Lcom/android/systemui/statusbar/RemoteInputController;ZLandroid/service/notification/StatusBarNotification;Landroid/service/notification/StatusBarNotification;)V
...
.method public static synthetic lambda$onWorkChallengeChanged$37(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V
    .locals 1
...
.method public static synthetic lambda$onWorkChallengeChanged$38(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;Lcom/android/systemui/statusbar/ExpandableNotificationRow;)V
    .locals 2

    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$j96cSNpAdKazwZ2nGsaARsdXzOk;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$j96cSNpAdKazwZ2nGsaARsdXzOk;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V
...
.method public static synthetic lambda$onWorkChallengeChanged$39(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 6
    ...
    new-instance v5, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$eoWDQ0ohibR1pIAC4B1Lhj__ei0;

    invoke-direct {v5, p0, v4, v2}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$eoWDQ0ohibR1pIAC4B1Lhj__ei0;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;Lcom/android/systemui/statusbar/ExpandableNotificationRow;)V
...
.method public static synthetic lambda$performDismissAllAnimations$15(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 1
...
.method public static synthetic lambda$postAnimateForceCollapsePanels$21(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method public static synthetic lambda$postQSRunnableDismissingKeyguard$29(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
    .locals 1
...
.method public static synthetic lambda$postQSRunnableDismissingKeyguard$30(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
    .locals 7
    ...
    new-instance v2, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$nBgz7pREWZfdv3WheeRgDYm-DKk;

    invoke-direct {v2, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$nBgz7pREWZfdv3WheeRgDYm-DKk;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
...
.method public static synthetic lambda$postStartActivityDismissingKeyguard$31(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)V
    .locals 0
...
.method public static synthetic lambda$postStartActivityDismissingKeyguard$32(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;)V
    .locals 1
...
.method public static synthetic lambda$removeNotification$42(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/service/notification/StatusBarNotification;)V
    .locals 1
...
.method public static synthetic lambda$removeNotification$43(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/service/notification/StatusBarNotification;)V
    .locals 2

    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gJKreMi_qTVFZxM5HzO_UrLMzKo;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gJKreMi_qTVFZxM5HzO_UrLMzKo;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/service/notification/StatusBarNotification;)V
...
.method public static synthetic lambda$startActivityDismissingKeyguard$23(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;IZLcom/android/systemui/plugins/ActivityStarter$Callback;)V
    .locals 19
...
.method static synthetic lambda$startActivityDismissingKeyguard$24(Lcom/android/systemui/plugins/ActivityStarter$Callback;)V
    .locals 1
...
.method public static synthetic lambda$startNotificationGutsIntent$44(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method public static synthetic lambda$startNotificationGutsIntent$45(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;Lcom/android/systemui/statusbar/ExpandableNotificationRow;I)V
    .locals 4
    ...
    new-instance v2, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$_vZAkEgFD58rmNKz3HhQR-4wie0;

    invoke-direct {v2, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$_vZAkEgFD58rmNKz3HhQR-4wie0;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public static synthetic lambda$startNotificationGutsIntent$46(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;Lcom/android/systemui/statusbar/ExpandableNotificationRow;I)Z
    .locals 1

    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$lhINUsDojuWVQD9mItU82YC3FuY;

    invoke-direct {v0, p0, p1, p2, p3}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$lhINUsDojuWVQD9mItU82YC3FuY;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;Lcom/android/systemui/statusbar/ExpandableNotificationRow;I)V
...
.method public static synthetic lambda$startPendingIntentDismissingKeyguard$47(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)V
    .locals 9
...
.method public static synthetic lambda$startPendingIntentDismissingKeyguard$48(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)Z
    .locals 2

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$WzR9w2Sq2NZeoIfsG2KA_Koe9lQ;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$WzR9w2Sq2NZeoIfsG2KA_Koe9lQ;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)V
...
.method public static synthetic lambda$updateHideIconsForBouncer$19(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 1
...
.method public static synthetic lambda$updateMediaMetaData$16(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    .locals 2
...
.method public static synthetic lambda$updateTheme$35(Lcom/android/systemui/statusbar/phone/StatusBar;Z)V
    .locals 3
...
.method private onThemeChanged()V
    ...
    invoke-virtual {v3}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->getLockIcon()Lcom/android/systemui/statusbar/phone/LockIcon;
...
.method private performDismissAllAnimations(Ljava/util/ArrayList;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$hz39WvlFDjmu3UFNVirp_TJxYPU;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$hz39WvlFDjmu3UFNVirp_TJxYPU;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method private removeNotification(Landroid/service/notification/StatusBarNotification;)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$anGzdKBNO9L0XzFdGlBFy1j85B0;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$anGzdKBNO9L0XzFdGlBFy1j85B0;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/service/notification/StatusBarNotification;)V
...
.method private showAmbientPlayIndication()V
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/android/systemui/ambient/play/AmbientIndicationContainer;->showIndication()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateDozingState()V
    ...
    invoke-static {v1}, Lcom/android/systemui/statusbar/phone/StatusBar$DozeServiceHost;->access$1400(Lcom/android/systemui/statusbar/phone/StatusBar$DozeServiceHost;)Z
...
.method private updateHideIconsForBouncer(Z)V
    ...
    new-instance v4, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$GPKlymtdaSWvEyRtwTRSFeYuvWc;

    invoke-direct {v4, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$GPKlymtdaSWvEyRtwTRSFeYuvWc;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method private updateNavigationBar()V
    ...
    invoke-static {v2}, Lcom/android/internal/util/custom/NavbarUtils;->isEnabled(Landroid/content/Context;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mShowNavBar:Z
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mWindowManager:Landroid/view/WindowManager;
    ...
    iput-object v3, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mNavigationBarView:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mNavigationBar:Lcom/android/systemui/statusbar/phone/NavigationBarFragment;
...
.method public clearAllNotifications()V
    ...
    :cond_8
    new-instance v3, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$KPpPJ6lHyblaC5nDSDIGtQv6sSs;

    invoke-direct {v3, p0, v2}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$KPpPJ6lHyblaC5nDSDIGtQv6sSs;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/util/ArrayList;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/systemui/statusbar/policy/FlashlightController;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public executeRunnableDismissingKeyguard(Ljava/lang/Runnable;Ljava/lang/Runnable;ZZZ)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$2o5DqwU7a8_lWJ0tlZXd7MAULTQ;

    invoke-direct {v0, p0, p1, p3, p5}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$2o5DqwU7a8_lWJ0tlZXd7MAULTQ;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;ZZ)V
...
.method public fadeKeyguardAfterLaunchTransition(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$VGVVEb9vvRl3UTavYqmJZkWnKBw;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$VGVVEb9vvRl3UTavYqmJZkWnKBw;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
...
.method public fadeKeyguardWhilePulsing()V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$WXAwBNkDB04G_NTCGmQtREbS760;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$WXAwBNkDB04G_NTCGmQtREbS760;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public handleRemoteViewClick(Landroid/view/View;Landroid/app/PendingIntent;Landroid/content/Intent;Lcom/android/systemui/statusbar/NotificationRemoteInputManager$ClickHandler;)Z
    ...
    new-instance v2, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$fzTDbkcnYrHu8s7M4OkG8bm4evI;

    invoke-direct {v2, p0, p4}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$fzTDbkcnYrHu8s7M4OkG8bm4evI;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/NotificationRemoteInputManager$ClickHandler;)V
...
.method protected makeStatusBarView()V
    ...
    iget-object v3, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->mNotificationPanel:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
    ...
    iget-object v0, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientIndicationContainer:Landroid/view/View;
    ...
    invoke-virtual {v0, v7}, Lcom/android/systemui/ambient/play/AmbientIndicationContainer;->initializeView(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    iput-object v0, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->ambientClearingHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/systemui/statusbar/phone/StatusBar$5;

    invoke-direct {v0, v7}, Lcom/android/systemui/statusbar/phone/StatusBar$5;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V

    iput-object v0, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->ambientClearingRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {v1, v7}, Lcom/android/systemui/statusbar/phone/StatusBar$6;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    iput-object v1, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->mFlashlightController:Lcom/android/systemui/statusbar/policy/FlashlightController;
...
.method public maybeEscalateHeadsUp()V
    ...
    sget-object v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$M-v6L0bCMELm_outZVi3FdfiHBc;->INSTANCE:Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$M-v6L0bCMELm_outZVi3FdfiHBc;
...
.method public onHeadsUpPinnedModeChanged(Z)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ay-YAvh4VjN9pBbLWxpXGraAy_o;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ay-YAvh4VjN9pBbLWxpXGraAy_o;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public onNotificationClicked(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/ExpandableNotificationRow;)V
    ...
    new-instance v15, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$cpS9GH1Yu7E8qLhdYAL6i-NlD18;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$cpS9GH1Yu7E8qLhdYAL6i-NlD18;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/String;Lcom/android/systemui/statusbar/ExpandableNotificationRow;Landroid/service/notification/StatusBarNotification;Landroid/app/PendingIntent;Lcom/android/systemui/statusbar/RemoteInputController;Z)V
...
.method public onUserSwitched(I)V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mSbSettingsObserver:Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;->update()V
...
.method public onWorkChallengeChanged()V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$brC3HWoW52IJ2KvIgjPoiblJKDY;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$brC3HWoW52IJ2KvIgjPoiblJKDY;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public postAnimateForceCollapsePanels()V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ozJF_5mXhWqttO3c_hxUQ5zEj6A;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ozJF_5mXhWqttO3c_hxUQ5zEj6A;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public postQSRunnableDismissingKeyguard(Ljava/lang/Runnable;)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$VX0QSn8fcyOHYuFyA6Hcoa2Oyxs;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$VX0QSn8fcyOHYuFyA6Hcoa2Oyxs;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Ljava/lang/Runnable;)V
...
.method public postStartActivityDismissingKeyguard(Landroid/app/PendingIntent;)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$12UpvPh4ei1S2fz4WfmdUVU3L0Q;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$12UpvPh4ei1S2fz4WfmdUVU3L0Q;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)V
...
.method public postStartActivityDismissingKeyguard(Landroid/content/Intent;I)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$N82XexCiKemcup5oDmr0rEQGLr8;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$N82XexCiKemcup5oDmr0rEQGLr8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;)V
...
.method protected setAreThereNotifications()V
    ...
    invoke-direct {v3, p0, v0}, Lcom/android/systemui/statusbar/phone/StatusBar$9;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/view/View;)V
...
.method public start()V
    ...
    iget-object v0, v8, Lcom/android/systemui/statusbar/phone/StatusBar;->mSbSettingsObserver:Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/StatusBar$SbSettingsObserver;->observe()V
    ...
    :goto_1
    invoke-virtual {v8, v1}, Lcom/android/systemui/statusbar/phone/StatusBar;->topAppWindowChanged(Z)V
    ...
    :goto_2
    invoke-virtual {v8, v1, v2, v3, v0}, Lcom/android/systemui/statusbar/phone/StatusBar;->setImeWindowStatus(Landroid/os/IBinder;IIZ)V
    ...
    invoke-virtual {v0, v3, v2, v4, v11}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    :try_start_2
    invoke-interface {v4, v12, v12}, Landroid/app/IWallpaperManager;->setInAmbientMode(ZZ)V
    :try_end_2
    ...
    new-instance v0, Lcom/android/systemui/ambient/play/AmbientIndicationManager;

    iget-object v5, v8, Lcom/android/systemui/statusbar/phone/StatusBar;->mContext:Landroid/content/Context;

    invoke-direct {v0, v5}, Lcom/android/systemui/ambient/play/AmbientIndicationManager;-><init>(Landroid/content/Context;)V

    iput-object v0, v8, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientIndicationManager:Lcom/android/systemui/ambient/play/AmbientIndicationManager;

    iget-object v0, v8, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientIndicationManager:Lcom/android/systemui/ambient/play/AmbientIndicationManager;

    iget-object v5, v8, Lcom/android/systemui/statusbar/phone/StatusBar;->mAmbientCallback:Lcom/android/systemui/ambient/play/AmbientIndicationManagerCallback;

    invoke-virtual {v0, v5}, Lcom/android/systemui/ambient/play/AmbientIndicationManager;->registerCallback(Lcom/android/systemui/ambient/play/AmbientIndicationManagerCallback;)V
...
.method public startActivityDismissingKeyguard(Landroid/content/Intent;ZZZLcom/android/systemui/plugins/ActivityStarter$Callback;I)V
    ...
    new-instance v8, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$m7gLn0oHyYCe-AWuyLsfac1q_Y8;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$m7gLn0oHyYCe-AWuyLsfac1q_Y8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;IZLcom/android/systemui/plugins/ActivityStarter$Callback;)V

    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$1nGExZ91Gpu3EQgUFwihi2varHw;

    invoke-direct {v1, p5}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$1nGExZ91Gpu3EQgUFwihi2varHw;-><init>(Lcom/android/systemui/plugins/ActivityStarter$Callback;)V
...
.method public startNotificationGutsIntent(Landroid/content/Intent;ILcom/android/systemui/statusbar/ExpandableNotificationRow;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ylzGEDYi80zloswFYhcbw61Vi1I;

    invoke-direct {v0, p0, p1, p3, p2}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ylzGEDYi80zloswFYhcbw61Vi1I;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/content/Intent;Lcom/android/systemui/statusbar/ExpandableNotificationRow;I)V
...
.method public startPendingIntentDismissingKeyguard(Landroid/app/PendingIntent;)V
    ...
    :goto_0
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$QlDPR1nqmBKUuYlZzAqmVP6qD_E;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$QlDPR1nqmBKUuYlZzAqmVP6qD_E;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/app/PendingIntent;)V
...
.method protected updateKeyguardState(ZZ)V
    ...
    :goto_1
    invoke-virtual {v0, v2, v3}, Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher;->setKeyguard(ZZ)V

    :cond_5
    invoke-direct {p0, v2, v2}, Lcom/android/systemui/statusbar/phone/StatusBar;->hideAmbientPlayIndication(IZ)V
...
.method public updateMediaMetaData(ZZ)V
    ...
    :goto_3
    iget-object v9, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;

    invoke-virtual {v9, v8}, Lcom/android/systemui/colorextraction/SysuiColorExtractor;->setHasBackdrop(Z)V
    ...
    new-instance v4, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$wlXP8P-mZcZXCFMAEy6t46bsTzE;

    invoke-direct {v4, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$wlXP8P-mZcZXCFMAEy6t46bsTzE;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method protected updateTheme()V
    ...
    iget-object v8, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;

    new-instance v9, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ivKR6xDECCYeSWtxcJR-qPFaXgc;

    invoke-direct {v9, p0, v1}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$ivKR6xDECCYeSWtxcJR-qPFaXgc;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;Z)V

    invoke-virtual {v8, v9}, Lcom/android/systemui/UiOffloadThread;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    :cond_5
    iget-object v8, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;

    invoke-virtual {v8, v4, v2}, Lcom/android/systemui/colorextraction/SysuiColorExtractor;->getColors(IZ)Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;

    move-result-object v8

    invoke-virtual {v8}, Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;->supportsDarkText()Z
    ...
    invoke-virtual {v10, v9}, Landroid/content/Context;->setTheme(I)V
    ...
    invoke-virtual {v10, v4, v2}, Lcom/android/systemui/colorextraction/SysuiColorExtractor;->getColors(IZ)Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    invoke-virtual {v10, v2}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->updateDecorViews(Z)V
    ...
    invoke-virtual {v10, v2}, Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;->setKeyguardDark(Z)V
